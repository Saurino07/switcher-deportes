...
const q=new URLSearchParams(location.search),game=q.get('game')||localStorage.getItem('switcherDirectorGame')||'partido1',code=q.get('code')||localStorage.getItem('switcherDirectorCode')||'',v='2700';
...
function openAdvanced(tab){const u=`./index.html?game=${encodeURIComponent(game)}&v=${v}&code=${encodeURIComponent(code)}&desktop=1&panel=${encodeURIComponent(tab)}&returnMobile=1`;location.href=u}
