...
const q=new URLSearchParams(location.search),game=q.get('game')||localStorage.getItem('switcherDirectorGame')||'partido1',code=q.get('code')||localStorage.getItem('switcherDirectorCode')||'',v='2800';
